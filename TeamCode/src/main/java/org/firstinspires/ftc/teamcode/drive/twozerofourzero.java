 ...
 */
@TeleOp(name="drivercontrolpressmedaddy33", group="sai")
//@Disabled  This way it will run on the robot
public class twozerofourzero extends OpMode {
  ...
  ;
        ...
        lift.setTargetPositionTolerance(50);
...
//________________________________________________________________________________________________________________________________________________________________________________________________________________-
        ...
        telemetry.addData("slidePosition", lift.getCurrentPosition());
        telemetry.addData("is at target", !lift.isBusy());
        //Arm Slide Data
        telemetry.addData("Target Slide Position", armLevelPosition[armLevel]);
        telemetry.addData("Slide Position", lift.getCurrentPosition());
        telemetry.addData("Velocity", lift.getVelocity());
        telemetry.addData("is at target", !lift.isBusy());
        telemetry.addData("Tolerance: ", lift.getTargetPositionTolerance());
...
//---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        lift.setTargetPosition(armLevelPosition[armLevel]);
        lift.setTargetPositionTolerance(armLevelPosition[armLevel]);
